...
export default function IndividualTeam({team, onClick}: IndividualTeamProps) { 
    return (
        <div key={team.id} className="bg-red-900 py-2 px-2 flex items-center hover:bg-red-600 hover:cursor-pointer active:bg-blue-400" onClick={() => onClick(team.players)}>
